...
iris1$SepalLength    #sélection de la variable "SepalLenght" dans le tableau "iris1"
iris1[c(1,5,10), ] #Sélection des lignes 1, 5 et 10 du tableau
iris1[-(5:30), ] # Sélection des lignes qui précèdent la 5ème ligne et des lignes après la ligne 30 du tableau
...
iris1[iris1$Species=="virginica" , ] # sélection de toutes les fleurs qui sont de l'espèce "Virginica"
...
t3var <- read.table("t3var.txt", header = TRUE, sep = "\t") #Import des données dans l'objet t3var
...
t3var[c(1,10,20), ]#Sélection des individus 1, 10 et 20



fem170 <- t3var[t3var$tai > 170 &  t3var$sexe=="f", ] #Séletion des femmes de plus de 170cm 
fem170
